...
function Footer() {
    return (
        <footer className="mt-32 bg-gray-100 sm:p-6 ">
            <div className="max-w-5xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                ...
                <ul className="flex flex-wrap justify-center gap-6 mt-12 md:gap-8 lg:gap-12">
                    ...
                    <li>
                        <Link className="text-gray-700 transition hover:text-gray-700/75" href="/"> Trending </Link>
                    </li>

                    <li>
                        <Link className="text-gray-700 transition hover:text-gray-700/75" href="/"> Categories </Link>
                    </li>

                    <li>
                        <Link className="text-gray-700 transition hover:text-gray-700/75" href="/"> Products </Link>
                    </li>
                </ul>
