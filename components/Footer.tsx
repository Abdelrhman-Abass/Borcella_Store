        ...
        <footer className="mt-32 bg-gray-100 sm:p-6 ">
            <div className="max-w-5xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                ...
                <ul className="flex justify-center gap-6 mt-12 md:gap-8">
                    ...
                    <li>
                        <Link
                            href="tel:01007582994" // Replace with your desired link if not a phone call
                            rel="noreferrer"
                            target="_blank"
                            className="text-gray-700 transition hover:text-gray-700/75 flex items-center"
                        >
                            <span className="sr-only">Phone</span>
                            <svg className="w-6 h-6 mr-1" fill="currentColor"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
